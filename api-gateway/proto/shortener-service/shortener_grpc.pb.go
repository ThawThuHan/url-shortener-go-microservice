...
const (
	...
	ShortenerService_GetOriginURLs_FullMethodName  = "/shortener.ShortenerService/GetOriginURLs"
)
...
type ShortenerServiceClient interface {
	...
	GetOriginURLs(ctx context.Context, in *GetOriginURLsRequest, opts ...grpc.CallOption) (*GetOriginURLsResponse, error)
}
...
func (c *shortenerServiceClient) GetOriginURLs(ctx context.Context, in *GetOriginURLsRequest, opts ...grpc.CallOption) (*GetOriginURLsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetOriginURLsResponse)
	err := c.cc.Invoke(ctx, ShortenerService_GetOriginURLs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShortenerServiceServer interface {
	...
	GetOriginURLs(context.Context, *GetOriginURLsRequest) (*GetOriginURLsResponse, error)
...
func (UnimplementedShortenerServiceServer) GetOriginURLs(context.Context, *GetOriginURLsRequest) (*GetOriginURLsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetOriginURLs not implemented")
}
...
func _ShortenerService_GetOriginURLs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOriginURLsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShortenerServiceServer).GetOriginURLs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ShortenerService_GetOriginURLs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShortenerServiceServer).GetOriginURLs(ctx, req.(*GetOriginURLsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ShortenerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetOriginURLs",
			Handler:    _ShortenerService_GetOriginURLs_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/shortener-service/shortener.proto",
}
